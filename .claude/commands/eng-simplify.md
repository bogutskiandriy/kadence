...
Invoke the eng-code-simplification skill.
...
If tests fail after a simplification, revert that change and reconsider. Use `eng-code-review-and-quality` to review the result.

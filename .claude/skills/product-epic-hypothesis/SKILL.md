...
source:
  ...
  path: pm-skills/skills/epic-hypothesis
...
- **Problem understanding:** What user problem does this address? (reference `../research-problem-statement/SKILL.md`)
- **Target persona:** Who benefits? (reference `../research-proto-persona/SKILL.md`)
- **Jobs-to-be-Done:** What outcome are they trying to achieve? (reference `../research-jtbd/SKILL.md`)
...
- **"For" is a clear persona:** Not "users" but "remote project managers juggling 3+ distributed teams" (reference `../research-proto-persona/SKILL.md`)
...
**Stories:**
1. [User Story 1 - reference `../product-user-story/SKILL.md`]
2. [User Story 2]
3. [User Story 3]
```
...
### Related Skills
- `../research-problem-statement/SKILL.md` — Hypothesis should address a validated problem
- `../research-proto-persona/SKILL.md` — Defines the "for [persona]" section
- `../research-jtbd/SKILL.md` — Informs the "then we will" outcome
- `../product-user-story/SKILL.md` — Validated epics decompose into user stories
- `../product-story-splitting/SKILL.md` — How to break validated epics into stories
...
**Suggested filename:** `product-epic-hypothesis.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-problem-statement/SKILL.md`, `../research-proto-persona/SKILL.md`, `../research-jtbd/SKILL.md`
**Used by:** `../product-user-story/SKILL.md`, `../product-story-splitting/SKILL.md`

...
source:
  ...
  path: addy-agent-skills/skills/api-and-interface-design
...
- **Plan for deprecation at design time.** See `deprecation-and-migration` (скіл відкладено) for how to safely remove things users depend on.

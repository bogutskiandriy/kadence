...
source:
  ...
  path: addy-agent-skills/skills/source-driven-development
...
For the underlying threat model (LLM01: Prompt Injection), follow the `eng-security-and-hardening` skill — this section covers extraction hygiene, that one covers the threat model.

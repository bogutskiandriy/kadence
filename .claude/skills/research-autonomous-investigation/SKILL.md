---
name: research-autonomous-investigation
...
source:
  ...
  path: pm-skills/skills/autonomous-investigation
...
Where `product-workshop-facilitation` governs skills that ask you questions one at a time, this protocol governs
...
| | `product-workshop-facilitation` | `research-autonomous-investigation` |
|---|---|---|
...
collection channels (see `intelligence-collection-disciplines` (скіл відкладено)):
...
- intelligence-collection-disciplines (скіл відкладено) (Component) —
  the eight collection channels whose signals this protocol labels and stacks
- [`product-workshop-facilitation`](../product-workshop-facilitation/SKILL.md) (Interactive) — the sibling protocol for
  skills where the *user* holds the context
- Investigation skills honoring this contract: `research-market-landscape`, `research-competitor-snapshot`,
  `competitive-intel-watch` (скіл відкладено), `battle-card-builder` (скіл відкладено) (References section of each names this protocol)

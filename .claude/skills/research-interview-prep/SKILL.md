...
source:
  ...
  path: pm-skills/skills/discovery-interview-prep
...
- Use `research-problem-statement.md` to frame findings
...
### Related Skills
- `research-problem-statement.md` — Use interview insights to frame problem statement
- `research-proto-persona.md` — Define interview target segment
- `research-jtbd.md` — JTBD methodology for interviews
...
**Suggested filename:** `research-interview-prep.md`
**Suggested placement:** `/skills/interactive/`
**Dependencies:** Uses `research-problem-statement.md`, `research-proto-persona.md`, `research-jtbd.md`

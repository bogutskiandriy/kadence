---
name: research-voice-of-customer
...
source:
  ...
  path: pm-skills/skills/voice-of-customer-miner
...
- **When NOT to use:** no meaningful public footprint (early-stage, niche enterprise) → run
  [`research-interview-prep`](../research-interview-prep/SKILL.md) instead; you need *your* users'
...
1. Generate discovery interview questions from the top theme ([`research-interview-prep`](../research-interview-prep/SKILL.md))
2. Feed the weaknesses into a competitive battle card (battle-card-builder (скіл відкладено))
3. Build an opportunity solution tree from the top hypothesis ([`research-opportunity-tree`](../research-opportunity-tree/SKILL.md))
...
- intelligence-collection-disciplines (скіл відкладено) (Component) — OSINT review-mining sources and bias tradecraft
- [`research-jtbd`](../research-jtbd/SKILL.md) (Component) — the solution-free framing themes should land in
- [`research-interview-prep`](../research-interview-prep/SKILL.md) (Interactive) — where the validation happens
- [`research-opportunity-tree`](../research-opportunity-tree/SKILL.md) (Interactive) — structures the opportunity hypotheses
- battle-card-builder (скіл відкладено) (Workflow) — consumes the weak points

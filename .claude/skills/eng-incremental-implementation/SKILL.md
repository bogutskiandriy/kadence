...
source:
  ...
  path: addy-agent-skills/skills/incremental-implementation
...
4. **Commit** -- save your progress with a descriptive message (see `eng-git-workflow-and-versioning` for atomic commit guidance)

...
source:
  ...
  path: pm-skills/skills/customer-journey-map
...
2. **Buyer personas:** Detailed personas with demographics, psychographics, goals, challenges (reference `../research-proto-persona/SKILL.md`)
...
### Related Skills
- `../research-proto-persona/SKILL.md` — Defines the persona for the journey map
- `../research-jtbd/SKILL.md` — Informs customer actions and goals
- `../research-problem-statement/SKILL.md` — Identifies pain points at each stage
- `../product-story-mapping/SKILL.md` — Complementary (story mapping focuses on product usage, journey mapping covers all touchpoints)
...
**Suggested filename:** `research-journey-map.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-proto-persona/SKILL.md`, `../research-jtbd/SKILL.md`, `../research-problem-statement/SKILL.md`

...
source:
  ...
  path: pm-skills/skills/prd-development
...
- **Skill cross-reference table** — maps 15 skills to the specific sections they feed (e.g., `research-problem-framing` → Section 2, `epic-breakdown-advisor` (скіл відкладено) → Section 7).
...
- **Input:** Discovery insights from `../research-discovery-process/SKILL.md` or `../research-problem-framing/SKILL.md`
- **Participants:** PM
- **Duration:** 30 minutes
...
- **Use:** `customer-journey-mapping-workshop` (скіл відкладено) output
- **Jobs-to-be-done:** If motivations are key
- **Use:** `../research-jtbd/SKILL.md` output
...
**1. Document Personas**
- **Use:** `../research-proto-persona/SKILL.md` (component) output
- **Participants:** PM
- **Duration:** 30 minutes
...
- **Use:** `../research-tam-sam-som/SKILL.md` (interactive) output
...
- **Use:** `user-story-mapping-workshop` (скіл відкладено) output
...
│  └─ Use: ../research-problem-statement/SKILL.md
├─ Phase 3: Target Users & Personas (30 min)
│  └─ Use: ../research-proto-persona/SKILL.md
└─ Phase 4: Strategic Context (45 min)
   └─ Use: ../research-tam-sam-som/SKILL.md (optional)

Day 2:
├─ Phase 5: Solution Overview (60 min)
│  └─ Use: user-story-mapping-workshop (скіл відкладено) (optional)
├─ Phase 6: Success Metrics (30 min)
└─ Phase 7: User Stories & Requirements (90-120 min)
   ├─ Use: ../product-epic-hypothesis/SKILL.md
   ├─ Use: epic-breakdown-advisor (скіл відкладено)
   └─ Use: ../product-user-story/SKILL.md
...
**Fix:** Use discovery insights from `../research-discovery-process/SKILL.md`; include customer quotes, analytics, support tickets
...
**Skill type:** Workflow
**Suggested filename:** `product-prd.md`

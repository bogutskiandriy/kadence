...
source:
  ...
  path: pm-skills/skills/lean-ux-canvas
...
Use [`product-workshop-facilitation`](../product-workshop-facilitation/SKILL.md) as the default interaction protocol for this skill.
...
3. **I'm not sure what the business problem is** — [Agent suggests starting with `../research-problem-statement/SKILL.md` or `../research-problem-framing/SKILL.md` first]
...
1. **I have personas already** — [Reference `../research-proto-persona/SKILL.md` or paste persona]
...
3. **I need to create personas first** — [Agent suggests using `../research-proto-persona/SKILL.md` component skill]
...
3. **I need to research this first** — [Agent suggests `../research-jtbd/SKILL.md` or `../research-interview-prep/SKILL.md`]
...
2. **Suggest related skills** to use next (e.g., `../research-interview-prep/SKILL.md` for customer interviews)?
...
**Fix:** Design smallest experiment first. If you can't think of one, use `../research-pol-probe-advisor/SKILL.md` to choose a validation method.
...
### Related Skills
- **[research-problem-statement](../research-problem-statement/SKILL.md)** (Component) — Frame problem before filling Box 1
- **[research-problem-framing](../research-problem-framing/SKILL.md)** (Interactive) — MITRE Problem Framing before canvas
- **[research-proto-persona](../research-proto-persona/SKILL.md)** (Component) — Create personas for Box 3
- **[research-jtbd](../research-jtbd/SKILL.md)** (Component) — Identify user benefits for Box 4
- **[product-epic-hypothesis](../product-epic-hypothesis/SKILL.md)** (Component) — Write testable hypotheses (Box 6)
- **[research-interview-prep](../research-interview-prep/SKILL.md)** (Interactive) — Design customer interviews for Box 8
- **[research-pol-probe-advisor](../research-pol-probe-advisor/SKILL.md)** (Interactive) — Choose experiment type for Box 8

...
source:
  ...
  path: pm-skills/skills/pestel-analysis
...
### Related Skills
- `../product-recommendation-canvas/SKILL.md` — PESTEL factors inform risk assessment in canvas
- `../product-positioning-statement/SKILL.md` — PESTEL insights shape competitive positioning
- `../research-problem-statement/SKILL.md` — Social/economic factors influence customer problems
...
**Suggested filename:** `research-pestel.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../product-recommendation-canvas/SKILL.md`, `../product-positioning-statement/SKILL.md`

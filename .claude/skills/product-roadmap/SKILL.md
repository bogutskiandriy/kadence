...
source:
  ...
  path: pm-skills/skills/roadmap-planning
...
- **Use:** Insights from `../research-discovery-process/SKILL.md` (if recently completed)
- **Questions:**
...
- `../research-discovery-process/SKILL.md` (workflow) — Provides customer problem inputs for Phase 1
- `user-story-mapping-workshop` (скіл відкладено) (interactive) — For complex epics requiring release planning
...
**Skill type:** Workflow
**Suggested filename:** `product-roadmap.md`
**Suggested placement:** `/skills/workflows/`
**Dependencies:** Orchestrates `../product-epic-hypothesis/SKILL.md`, `../product-prioritization/SKILL.md`, plus manual activities

...
source:
  ...
  path: pm-skills/skills/competitive-analysis-process
...
does the work — the way `research-discovery-process` orchestrates the discovery skills. Run all six for a
...
`research-company-intel` output — so steps consume rather than repeat it.
...
- **Evidence discipline throughout.** Every step honors the
  [`research-autonomous-investigation`](../research-autonomous-investigation/SKILL.md) protocol
  (Fact/Inference/Assumption labels, real URLs, confidence stacking), drawing signals from the
  channels in intelligence-collection-disciplines (скіл відкладено).
...
[`research-market-landscape`](../research-market-landscape/SKILL.md) to find it), and which steps matter.
...
- **Run:** [`research-market-landscape`](../research-market-landscape/SKILL.md) — segments, player map,
...
- **Run:** [`research-competitor-snapshot`](../research-competitor-snapshot/SKILL.md) on the
...
- **Run:** [`research-voice-of-customer`](../research-voice-of-customer/SKILL.md) across the sources your
...
- **Run:** [`research-company-intel`](../research-company-intel/SKILL.md) per deep-dive competitor — its eleven-section
  output (financials, offers, org signals) is this step's artifact; FININT sources per
  `intelligence-collection-disciplines` (скіл відкладено) do the heavy lifting.
...
- **Run:** contrast their *stated* positioning (Step 2 snapshots) against *customer language* (Step 3
  review mining); draft or revise with [`product-positioning-statement`](../product-positioning-statement/SKILL.md).
...
- **Run:** the forward-looking disciplines in
  intelligence-collection-disciplines (скіл відкладено) — TECHINT
  ...
  confidence-stacking rule. competitive-intel-watch (скіл відкладено) keeps
...
1. **Battle cards** for the field — battle-card-builder (скіл відкладено)
...
Then set the maintenance cadence: competitive-intel-watch (скіл відкладено) on
the schedule the artifact mapping in `intelligence-collection-disciplines` (скіл відкладено) prescribes (weekly SIGINT
...
- [`research-market-landscape`](../research-market-landscape/SKILL.md) (Workflow) — Step 1
- [`research-competitor-snapshot`](../research-competitor-snapshot/SKILL.md) (Workflow) — Step 2
- [`research-voice-of-customer`](../research-voice-of-customer/SKILL.md) (Workflow) — Step 3
- [`research-company-intel`](../research-company-intel/SKILL.md) (Workflow) — Step 4
- [`product-positioning-statement`](../product-positioning-statement/SKILL.md) (Component) — Step 5
- competitive-intel-watch (скіл відкладено) (Workflow) — Step 6 cadence + maintenance
- battle-card-builder (скіл відкладено) (Workflow) — Step 7 output
- intelligence-collection-disciplines (скіл відкладено) (Component) — signal channels throughout
- [`research-autonomous-investigation`](../research-autonomous-investigation/SKILL.md) (Workflow) — evidence discipline throughout

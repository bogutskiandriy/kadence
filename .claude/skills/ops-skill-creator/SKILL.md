...
source:
  ...
  path: pm-skills/skills/pm-skill-creator
...
**a) A working name** — lowercase-kebab-case, max 64 characters (e.g., `feature-investment-advisor` (скіл відкладено), `product-user-story`, `research-discovery-process`)
...
2. Roadmap planning → workflow skill (already exists: `product-roadmap`)
3. Prioritization → interactive skill (already exists: `product-prioritization`)
4. Something else
...
- [`product-workshop-facilitation`](../product-workshop-facilitation/SKILL.md) — Facilitation protocol for this interactive skill

...
source:
  ...
  path: pm-skills/skills/proto-persona
...
- **Product context:** What problem are you solving? (reference `../research-problem-statement/SKILL.md`)
...
#### Pains
What problems or frustrations does this persona experience? (Reference `../research-jtbd/SKILL.md` for structure.)
...
### Related Skills
- `../research-problem-statement/SKILL.md` — Persona informs the "I am" section
- `../research-jtbd/SKILL.md` — JTBD informs persona pains/goals
- `../product-positioning-statement/SKILL.md` — Persona is the "For [target]"
- `../product-user-story/SKILL.md` — Stories use "As a [persona]"
...
**Suggested filename:** `research-proto-persona.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-jtbd/SKILL.md`, `../research-problem-statement/SKILL.md`
**Used by:** `../product-positioning-statement/SKILL.md`, `../product-user-story/SKILL.md`, `../research-problem-statement/SKILL.md`

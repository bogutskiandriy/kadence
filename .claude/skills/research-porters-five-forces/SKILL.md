---
name: research-porters-five-forces
...
source:
  ...
  path: pm-skills/skills/porters-five-forces
...
[`research-market-landscape`](../research-market-landscape/SKILL.md) in session — the forces read builds on
...
- **Industry, not player:** this reads what the structure does to *everyone* who plays.
  [`research-swot`](../research-swot/SKILL.md) reads one company's position within it.
...
2. Run [`research-market-landscape`](../research-market-landscape/SKILL.md) to name the players behind each force
3. Feed the profit-pool read into an Ansoff growth-options analysis (ansoff-matrix (скіл відкладено))
...
FSM-software market) that builds on the `research-market-landscape` example and lands at a profit-pool
...
- intelligence-collection-disciplines (скіл відкладено) (Component) — FININT/OSINT sources behind the signals
- [`research-market-landscape`](../research-market-landscape/SKILL.md) (Workflow) — who plays; this skill asks what the structure does to them
- [`research-swot`](../research-swot/SKILL.md) (Workflow) — one company's position within the structure
- ansoff-matrix (скіл відкладено) (Workflow) — growth options informed by the profit-pool read

...
source:
  ...
  path: pm-skills/skills/acquisition-channel-advisor
...
### Related Skills
- `saas-economics-efficiency-metrics` (скіл відкладено) — CAC, LTV, payback, magic number calculations
- `saas-revenue-growth-metrics` (скіл відкладено) — NRR, churn, cohort analysis by channel
- `product-finance-metrics` — Fast lookup for channel evaluation metrics
- `feature-investment-advisor` (скіл відкладено) — Similar ROI framework for feature decisions
- `business-health-diagnostic` (скіл відкладено) — Broader business health assessment

...
source:
  ...
  path: pm-skills/skills/tam-sam-som-calculator
...
sizing as an investigation under the [`research-autonomous-investigation`](../research-autonomous-investigation/SKILL.md)
...
### Related Skills
- `../product-positioning-statement/SKILL.md` — TAM/SAM/SOM informs "For [target]" segment size
- `../research-problem-statement/SKILL.md` — Problem space defines the market
- `../product-recommendation-canvas/SKILL.md` — Market sizing informs business outcome projections
- `../research-autonomous-investigation/SKILL.md` — The protocol governing Mode 3 (research mode)
- `intelligence-collection-disciplines` (скіл відкладено) — GEOINT/DEMOINT sources for the bottom-up recipe; FININT for capture rates
- `../research-market-landscape/SKILL.md` — Maps the segments worth sizing (structure before magnitude)
...
**Suggested filename:** `research-tam-sam-som.md`

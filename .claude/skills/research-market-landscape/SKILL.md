...
source:
  ...
  path: pm-skills/skills/market-landscape-scan
...
`research-autonomous-investigation` contract.
...
- **Governing protocol:** this skill honors the [`research-autonomous-investigation`](../research-autonomous-investigation/SKILL.md)
...
1. Run [`research-competitor-snapshot`](../research-competitor-snapshot/SKILL.md) on the deep-dive players
2. Run [`research-tam-sam-som`](../research-tam-sam-som/SKILL.md) sizing on the most promising segment
3. Draft a positioning hypothesis against this landscape ([`product-positioning-statement`](../product-positioning-statement/SKILL.md))
...
market) whose output feeds the `research-competitor-snapshot` example — the chain's schemas
...
- [`research-competitor-snapshot`](../research-competitor-snapshot/SKILL.md) (Workflow) — deep-dive on the players this scan surfaces
- [`research-tam-sam-som`](../research-tam-sam-som/SKILL.md) (Component) — sizes the segments this scan maps
- [`product-positioning-statement`](../product-positioning-statement/SKILL.md) (Component) — positions against this landscape

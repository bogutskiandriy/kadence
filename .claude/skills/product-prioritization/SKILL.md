...
source:
  ...
  path: pm-skills/skills/prioritization-advisor
...
### Related Skills
- `product-user-story.md` — Prioritized features become user stories
- `product-epic-hypothesis.md` — Prioritized epics validated with experiments
- `product-recommendation-canvas.md` — Business outcomes inform prioritization
...
**Suggested filename:** `product-prioritization.md`

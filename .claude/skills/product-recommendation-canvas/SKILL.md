---
name: product-recommendation-canvas
...
source:
  ...
  path: pm-skills/skills/recommendation-canvas
...
- **Problem understanding:** User research, pain points (reference `../research-problem-statement/SKILL.md`)
- **Persona clarity:** Who experiences the problem? (reference `../research-proto-persona/SKILL.md`)
...
Use the problem framing narrative from `../research-problem-statement/SKILL.md`:
...
Use the epic hypothesis format from `../product-epic-hypothesis/SKILL.md`:
...
Use the positioning statement format from `../product-positioning-statement/SKILL.md`:
...
### Related Skills
- `../research-problem-statement/SKILL.md` — Informs the problem narrative
- `../product-epic-hypothesis/SKILL.md` — Informs the solution hypothesis structure
- `../product-positioning-statement/SKILL.md` — Informs positioning section
- `../research-proto-persona/SKILL.md` — Defines target persona
- `../research-jtbd/SKILL.md` — Informs customer outcomes
...
**Suggested filename:** `product-recommendation-canvas.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-problem-statement/SKILL.md`, `../product-epic-hypothesis/SKILL.md`, `../product-positioning-statement/SKILL.md`, `../research-proto-persona/SKILL.md`, `../research-jtbd/SKILL.md`

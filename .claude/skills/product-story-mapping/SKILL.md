...
source:
  ...
  path: pm-skills/skills/user-story-mapping
...
#### Persona
Provide details about the persona within this segment (reference `../research-proto-persona/SKILL.md`).
...
What is the user trying to accomplish? Frame this as a Jobs-to-be-Done statement (reference `../research-jtbd/SKILL.md`).
...
### Related Skills
- `../research-proto-persona/SKILL.md` — Defines the persona for the story map
- `../research-jtbd/SKILL.md` — Informs the narrative and activities
- `../product-user-story/SKILL.md` — Tasks from the map become user stories
- `../research-problem-statement/SKILL.md` — Problem statement frames the narrative
...
**Suggested filename:** `product-story-mapping.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-proto-persona/SKILL.md`, `../research-jtbd/SKILL.md`, `../product-user-story/SKILL.md`, `../research-problem-statement/SKILL.md`

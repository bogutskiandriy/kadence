...
source:
  ...
  path: addy-agent-skills/skills/code-review-and-quality
...
For detailed security guidance, see `eng-security-and-hardening`. Does the change introduce vulnerabilities?
...
For detailed profiling and optimization, see `eng-performance-optimization`. Does the change introduce performance problems?
...
For triaging `npm audit` findings and supply-chain risk (typosquatting, compromised maintainers), follow the `eng-security-and-hardening` skill — this section covers the upgrade *workflow*, that one covers the security verdict.

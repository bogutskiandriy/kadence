...
source:
  ...
  path: pm-skills/skills/problem-statement
...
- **Jobs-to-be-Done insights:** What users are "hiring" your product to do (reference `../research-jtbd/SKILL.md`)
- **Persona clarity:** Who specifically experiences this problem (reference `../research-proto-persona/SKILL.md`)
...
### Related Skills
- `../research-jtbd/SKILL.md` — Informs the "Trying to" and "But" sections
- `../research-proto-persona/SKILL.md` — Defines the "I am" persona
- `../product-positioning-statement/SKILL.md` — Problem statement informs positioning
- `../product-user-story/SKILL.md` — Problem statement guides story prioritization
...
**Suggested filename:** `research-problem-statement.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-jtbd/SKILL.md`, `../research-proto-persona/SKILL.md`

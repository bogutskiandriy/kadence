...
source:
  ...
  path: pm-skills/skills/company-intel
  commit: a03af68414bb0b924746c97bddf9a5057d017af7
---
...
labels from [`research-autonomous-investigation`](../research-autonomous-investigation/SKILL.md): **Fact**
...
3. **Positioning statement** — Use `product-positioning-statement` skill with this company/market context loaded
4. **PESTEL assessment** — Use `research-pestel` skill with the trends and pressures from Sections 6 and 8
5. **Market sizing (TAM/SAM/SOM)** — Use `research-tam-sam-som` skill with the market and segment data from Sections 2-3
...
competitive-intel-watch (скіл відкладено); this refresh goes deep on one company.
...
| 2. How It Makes Money | Revenue, costs, margins, financial logic | `business-health-diagnostic` (скіл відкладено), `feature-investment-advisor` (скіл відкладено) |
| 3. Who It Serves | Buyers, users, segments, stakeholder map | `research-proto-persona`, `research-jtbd`, `product-positioning-statement` |
| 4. What It Sells or Delivers | Value propositions, core offers | `product-positioning-statement`, battlecards |
| 5. Key Product Lines | Product families, platforms, services | Competitive analysis, portfolio mapping |
| 6. Business and Market Pressures | Competitive, regulatory, technology forces | `research-pestel`, `product-derisk-measurement` |
| 7. Competitors and Alternatives | Direct, adjacent, substitutes, disruptors | Battlecards, competitive positioning |
| 8. Important Trends and Risks | Macro forces, AI impact, consolidation | `research-pestel`, `product-derisk-measurement` |
...
```markdown
- **[research-company-intel](../research-company-intel/SKILL.md)** (Workflow) — Run first to generate structured company/industry research; this skill consumes Sections [X, Y, Z] as input
```
...
### Related Skills
- **company-research (скіл відкладено)** (Component) — Lighter-weight company profile focused on executive quotes and product strategy; `research-company-intel` is deeper and broader, producing structured output for downstream consumption
- **[research-autonomous-investigation](../research-autonomous-investigation/SKILL.md)** (Workflow) — The evidence-label and confidence protocol this skill's research follows
- **intelligence-collection-disciplines (скіл відкладено)** (Component) — OSINT/FININT/HUMINT source tables and signal chains behind Lenses 1, 6, and 7
- **competitive-intel-watch (скіл відкладено)** (Workflow) — Breadth sibling: monitors the whole competitor set on a cadence while this skill goes deep on one entity
- **[research-pestel](../research-pestel/SKILL.md)** (Component) — Deep PESTEL template; consumes Sections 6 and 8 from company-intel
- **[product-derisk-measurement](../product-derisk-measurement/SKILL.md)** (Interactive) — Risk scan that benefits from Sections 6 and 8 as context input
- **[research-tam-sam-som](../research-tam-sam-som/SKILL.md)** (Component) — Market sizing; consumes Sections 2, 3, 5
- **business-health-diagnostic (скіл відкладено)** (Interactive) — SaaS health diagnosis; consumes Section 2
- **[product-positioning-statement](../product-positioning-statement/SKILL.md)** (Component) — Positioning; consumes Sections 3, 4, 7
- **[gtm-acquisition-channels](../gtm-acquisition-channels/SKILL.md)** (Interactive) — Go-to-market analysis; consumes Sections 2, 3, 7
- **[research-proto-persona](../research-proto-persona/SKILL.md)** (Component) — Persona creation; consumes Section 3

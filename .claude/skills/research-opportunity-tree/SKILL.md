---
name: research-opportunity-tree
...
source:
  ...
  path: pm-skills/skills/opportunity-solution-tree
...
### Related Skills
- `../research-problem-statement/SKILL.md` — Frames opportunities as customer problems
- `../research-jtbd/SKILL.md` — Helps identify opportunities from JTBD research
- `../product-epic-hypothesis/SKILL.md` — Turns validated solutions into testable epics
- `../product-user-story/SKILL.md` — Breaks experiments into deliverable stories
- `../research-interview-prep/SKILL.md` — Validates opportunities through customer interviews
...
**Suggested filename:** `research-opportunity-tree.md`
**Suggested placement:** `/skills/interactive/`
**Dependencies:** Uses `../research-problem-statement/SKILL.md`, `../research-jtbd/SKILL.md`, `../product-epic-hypothesis/SKILL.md`, `../product-user-story/SKILL.md`

...
source:
  ...
  path: pm-skills/skills/swot-analysis
...
session (a [`research-competitor-snapshot`](../research-competitor-snapshot/SKILL.md), VoC themes, a
landscape scan, [`research-company-intel`](../research-company-intel/SKILL.md) output): the SWOT then *synthesizes*
...
- **Governing protocol:** honors the [`research-autonomous-investigation`](../research-autonomous-investigation/SKILL.md)
  ...
  FININT + HUMINT per intelligence-collection-disciplines (скіл відкладено).
...
- **Companion, not substitute:** [`research-porters-five-forces`](../research-porters-five-forces/SKILL.md) reads the
...
1. Run the W-T exposure into a battle card or risk plan (battle-card-builder (скіл відкладено))
2. SWOT a second company for side-by-side comparison
3. Feed the crossings into a positioning statement ([`product-positioning-statement`](../product-positioning-statement/SKILL.md))
...
- intelligence-collection-disciplines (скіл відкладено) (Component) — the evidence channels behind each quadrant
- [`research-porters-five-forces`](../research-porters-five-forces/SKILL.md) (Workflow) — industry structure; run both for market-entry decisions
- [`research-competitor-snapshot`](../research-competitor-snapshot/SKILL.md) (Workflow) — upstream evidence base
- [`research-voice-of-customer`](../research-voice-of-customer/SKILL.md) (Workflow) — the weaknesses quadrant's best source
- [`product-positioning-statement`](../product-positioning-statement/SKILL.md) (Component) — consumes the crossings

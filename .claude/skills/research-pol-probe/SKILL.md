...
source:
  ...
  path: pm-skills/skills/pol-probe
...
### Related Skills
- **[research-pol-probe-advisor](../research-pol-probe-advisor/SKILL.md)** (Interactive) — Decision framework for choosing which prototype type to use
- **[research-discovery-process](../research-discovery-process/SKILL.md)** (Workflow) — Use PoL probes in validation phase
- **[research-problem-statement](../research-problem-statement/SKILL.md)** (Component) — Define problem before creating PoL probe
- **[product-epic-hypothesis](../product-epic-hypothesis/SKILL.md)** (Component) — Frame hypothesis before testing with PoL probe

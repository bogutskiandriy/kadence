...
source:
  ...
  path: pm-skills/skills/problem-framing-canvas
...
1. **Validate with users:** Use `../research-interview-prep/SKILL.md` to test reframed problem with customers
2. **Generate solutions:** Use `../research-opportunity-tree/SKILL.md` to explore solution space
3. **Create problem statement:** Use `../research-problem-statement/SKILL.md` to formalize for PRD/roadmap
...
### Related Skills
- `../research-problem-statement/SKILL.md` — Converts reframed problem into formal problem statement
- `../research-opportunity-tree/SKILL.md` — Uses HMW statement to generate solution options
- `../research-interview-prep/SKILL.md` — Validates reframed problem with customers
...
**Suggested filename:** `research-problem-framing.md`
**Suggested placement:** `/skills/interactive/`
**Dependencies:** Uses `../research-problem-statement/SKILL.md`

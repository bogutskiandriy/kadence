---
name: research-pol-probe-advisor
...
source:
  ...
  path: pm-skills/skills/pol-probe-advisor
...
❌ **Don't use this when:**
- You don't have a hypothesis yet (use `research-problem-statement.md` or `research-problem-framing.md` first)
...
**Next Step:** Would you like me to generate a `research-pol-probe` artifact documenting this feasibility check?
...
**Next Step:** Would you like me to generate a `research-pol-probe` artifact documenting this task-focused test?
...
**Next Step:** Would you like me to generate a `research-pol-probe` artifact documenting this narrative prototype?
...
**Next Step:** Would you like me to generate a `research-pol-probe` artifact documenting this synthetic data simulation?
...
**Next Step:** Would you like me to generate a `research-pol-probe` artifact documenting this vibe-coded probe?
...
1. **Generate a complete `research-pol-probe` artifact** (using the `research-pol-probe.md` template) with your hypothesis, success criteria, timeline, and disposal plan?
...
### Related Skills
- **[research-pol-probe](../research-pol-probe/SKILL.md)** (Component) — Template for documenting PoL probes
- **[research-problem-statement](../research-problem-statement/SKILL.md)** (Component) — Frame problem before choosing validation method
- **[research-problem-framing](../research-problem-framing/SKILL.md)** (Interactive) — MITRE Problem Framing before validation
- **[research-discovery-process](../research-discovery-process/SKILL.md)** (Workflow) — Use PoL probes in validation phase
- **[product-epic-hypothesis](../product-epic-hypothesis/SKILL.md)** (Component) — Turn epics into testable hypotheses

...
source:
  ...
  path: pm-skills/skills/product-strategy-session
...
When running this workflow as a guided conversation, use [`product-workshop-facilitation`](../product-workshop-facilitation/SKILL.md) as the interaction protocol.
...
- **Use:** `../research-interview-prep/SKILL.md` (interactive)
...
- **Use:** `../research-problem-framing/SKILL.md` (interactive - MITRE)
...
- **Use:** `../research-problem-statement/SKILL.md` (component)
- **Participants:** PM
- **Duration:** 30 minutes
- **Output:** Structured problem statement for PRD/roadmap

**3. Map Customer Journey (Optional)**
- **Use:** `customer-journey-mapping-workshop` (скіл відкладено) (interactive)
...
- **Use:** `../research-opportunity-tree/SKILL.md` (interactive)
...
- **Use:** `../product-lean-ux-canvas/SKILL.md` (interactive)
...
- Design POC experiments per `../research-opportunity-tree/SKILL.md` output
...
- **Use:** `../product-prioritization/SKILL.md` (interactive)
- **Participants:** PM
- **Duration:** 30 minutes
...
- **Use:** `../research-tam-sam-som/SKILL.md` (interactive)
...
- **Use:** `press-release` (скіл відкладено) (component)
...
- **Use:** `epic-breakdown-advisor` (скіл відкладено) (interactive - with Richard Lawrence's 9 patterns)
- **Participants:** PM, design, engineering
- **Duration:** 90 minutes
- **Output:** User stories split by patterns (workflow, CRUD, business rules, etc.)

**2. Write User Stories**
- **Use:** `../product-user-story/SKILL.md` (component)
- **Participants:** PM
...
│  ├─ positioning-workshop (скіл відкладено) (90 min)
│  ├─ ../research-proto-persona/SKILL.md (60 min)
│  └─ ../research-jtbd/SKILL.md (60 min)
│
├─ Day 3-5: Problem Framing & Validation
│  ├─ ../research-problem-framing/SKILL.md (120 min)
│  ├─ ../research-problem-statement/SKILL.md (30 min)
│  └─ [Optional] customer-journey-mapping-workshop (скіл відкладено) (90 min)
│
└─ Decision: Validate problem? (if NO, +1 week discovery)

Week 2:
├─ Day 1-3: Solution Exploration
│  ├─ ../research-opportunity-tree/SKILL.md (90 min)
│  ├─ ../product-epic-hypothesis/SKILL.md (60 min per epic)
│  └─ [Optional] user-story-mapping-workshop (скіл відкладено) (120 min)
│
├─ Decision: Test solutions? (if YES, +1-2 weeks experiments)
│
└─ Day 4-5: Prioritization & Roadmap
   ├─ ../product-prioritization/SKILL.md (30 min)
   ├─ Score & prioritize epics (90 min)
   ├─ Sequence roadmap (60 min)
   └─ [Optional] ../research-tam-sam-som/SKILL.md (60 min)

Week 3:
└─ Stakeholder Alignment
   ├─ [Optional] press-release (скіл відкладено) (60 min)
   ├─ Present strategy (60 min)
   └─ Refine based on feedback (1-2 days)

Week 4:
└─ Execution Planning
   ├─ epic-breakdown-advisor (скіл відкладено) (90 min)
   ├─ ../product-user-story/SKILL.md (30 min per story)
...
**Phase 1:**
- `positioning-workshop` (скіл відкладено) (interactive)
- `../research-proto-persona/SKILL.md` (component)
- `../research-jtbd/SKILL.md` (component)

**Phase 2:**
- `../research-problem-framing/SKILL.md` (interactive)
- `../research-problem-statement/SKILL.md` (component)
- `customer-journey-mapping-workshop` (скіл відкладено) (interactive, optional)
- `../research-interview-prep/SKILL.md` (interactive, if validation needed)

**Phase 3:**
- `../research-opportunity-tree/SKILL.md` (interactive)
- `../product-lean-ux-canvas/SKILL.md` (interactive, alternative)
- `../product-epic-hypothesis/SKILL.md` (component)
- `user-story-mapping-workshop` (скіл відкладено) (interactive, optional)

**Phase 4:**
- `../product-prioritization/SKILL.md` (interactive)
- `../research-tam-sam-som/SKILL.md` (interactive, optional)

**Phase 5:**
- `press-release` (скіл відкладено) (component, optional)

**Phase 6:**
- `epic-breakdown-advisor` (скіл відкладено) (interactive)
- `../product-user-story/SKILL.md` (component)

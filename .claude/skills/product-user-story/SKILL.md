...
source:
  ...
  path: pm-skills/skills/user-story
...
- When stories are too large (split first—see `../product-story-splitting/SKILL.md`)
...
- **User persona:** Who is this for? (reference `../research-proto-persona/SKILL.md`)
- **Problem understanding:** What need does this address? (reference `../research-problem-statement/SKILL.md`)
...
**Red flags:**
- **Multiple Whens/Thens:** Sign of scope creep—split the story (reference `../product-story-splitting/SKILL.md`)
...
- **Check for splitting:** If the story feels too big, use `../product-story-splitting/SKILL.md`
...
**Fix:** Use specific personas: "As a trial user," "As a paid subscriber," "As an admin," etc. (reference `../research-proto-persona/SKILL.md`)
...
**Fix:** Split the story using `../product-story-splitting/SKILL.md`. Each When/Then pair should be its own story (or at least evaluated for splitting).
...
### Related Skills
- `../product-story-splitting/SKILL.md` — How to break large stories into smaller ones
- `../research-proto-persona/SKILL.md` — Defines the "As a [persona]" section
- `../research-problem-statement/SKILL.md` — Stories should address validated problems
- `../product-epic-hypothesis/SKILL.md` — Epics decompose into user stories
...
**Suggested filename:** `product-user-story.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-proto-persona/SKILL.md`, `../research-problem-statement/SKILL.md`
**Used by:** `../product-story-splitting/SKILL.md`, `../product-epic-hypothesis/SKILL.md`

...
source:
  ...
  path: pm-skills/skills/finance-metrics-quickref
...
**Don't use this when:**
- You need detailed calculation guidance (use `saas-revenue-growth-metrics` (скіл відкладено) or `saas-economics-efficiency-metrics` (скіл відкладено))
...
- `saas-revenue-growth-metrics` (скіл відкладено) — Detailed guidance on revenue, retention, and growth metrics (13 metrics)
- `saas-economics-efficiency-metrics` (скіл відкладено) — Detailed guidance on unit economics and capital efficiency (17 metrics)
- `feature-investment-advisor` (скіл відкладено) — Uses these metrics to evaluate feature ROI
- `gtm-acquisition-channels` — Uses these metrics to evaluate channel viability
- `finance-based-pricing-advisor` (скіл відкладено) — Uses these metrics to evaluate pricing changes
- `business-health-diagnostic` (скіл відкладено) — Uses these metrics to diagnose business health

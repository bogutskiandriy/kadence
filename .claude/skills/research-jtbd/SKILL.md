...
source:
  ...
  path: pm-skills/skills/jobs-to-be-done
...
- **Target customer segment:** Who are you studying? (reference `../research-proto-persona/SKILL.md`)
...
- **Cross-reference with personas:** Do different personas have different jobs/pains/gains? (reference `../research-proto-persona/SKILL.md`)
...
### Related Skills
- `../research-proto-persona/SKILL.md` — Defines who has these jobs/pains/gains
- `../research-problem-statement/SKILL.md` — JTBD informs the "Trying to" and "But" sections
- `../product-positioning-statement/SKILL.md` — JTBD informs the "that need" statement
...
**Suggested filename:** `research-jtbd.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-proto-persona/SKILL.md`
**Used by:** `../product-positioning-statement/SKILL.md`, `../research-problem-statement/SKILL.md`, `../product-epic-hypothesis/SKILL.md`

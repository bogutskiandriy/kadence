...
source:
  ...
  path: pm-skills/skills/positioning-statement
...
- **Underserved need:** Pains, gains, jobs-to-be-done (reference `../research-jtbd/SKILL.md` if needed)
...
### Related Skills
- `../research-problem-statement/SKILL.md` — Defines the problem positioning addresses
- `../research-jtbd/SKILL.md` — Informs the "that need" statement
- `../research-proto-persona/SKILL.md` — Defines the "For [target]" segment
- `press-release` (скіл відкладено) — Positioning informs press release messaging
...
**Suggested filename:** `product-positioning-statement.md`
**Suggested placement:** `/skills/components/`
**Dependencies:** References `../research-problem-statement/SKILL.md`, `../research-jtbd/SKILL.md`, `../research-proto-persona/SKILL.md`

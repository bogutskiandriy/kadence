---
name: product-derisk-measurement
...
source:
  ...
  path: pm-skills/skills/derisk-measurement-advisor
...
**Don't use this when:**
- You don't have a specific product idea yet (use `research-problem-framing` first)
- You need a deep PESTEL analysis with data and citations (use `research-pestel` component skill)
- You've already validated the idea and need to pick a validation method (use `research-pol-probe-advisor`)
...
2. **Run a full PESTEL analysis** — use the `research-pestel` skill for a deep external-forces dive
3. **Pick a validation method** — use the `research-pol-probe-advisor` to choose the cheapest test for your top risk
...
### Related Skills
- **[research-pestel](../research-pestel/SKILL.md)** (Component) — Deep-dive PESTEL template with data-driven analysis across all 6 categories; use after this skill surfaces external risks worth investigating further
- **[research-pol-probe-advisor](../research-pol-probe-advisor/SKILL.md)** (Interactive) — Choose the cheapest validation method for your highest-priority act-now risk
- **[research-pol-probe](../research-pol-probe/SKILL.md)** (Component) — Document a Proof of Life probe for a specific risk
- **[product-recommendation-canvas](../product-recommendation-canvas/SKILL.md)** (Component) — Structure a go/no-go recommendation using risk register findings
- **[research-problem-framing](../research-problem-framing/SKILL.md)** (Interactive) — Frame the problem before scanning for risks

---
name: research-discovery-process
...
source:
  ...
  path: pm-skills/skills/discovery-process
...
- **Methodology:** From `../research-interview-prep/SKILL.md` (Problem validation, JTBD, switch interviews, etc.)
...
**3. Write PRD (If GO)**
- **Use:** `../product-prd/SKILL.md` (workflow)
- **Participants:** PM
- **Duration:** 1-2 days
...
│  └─ [Optional] ../research-proto-persona/SKILL.md, ../research-jtbd/SKILL.md
│
├─ Day 3: Research Planning
│  ├─ ../research-interview-prep/SKILL.md (90 min)
...
└─ Decide & Document
   ...
   ├─ [If GO] ../product-epic-hypothesis/SKILL.md (60 min per epic)
   ├─ [If GO] ../product-prd/SKILL.md (1-2 days)
...
**Fix:** Use Mom Test questions from `../research-interview-prep/SKILL.md` (focus on past behavior)
...
- `../research-proto-persona/SKILL.md` (component, optional)
- `../research-jtbd/SKILL.md` (component, optional)

**Phase 2:**
- `../research-interview-prep/SKILL.md` (interactive)
...
**Skill type:** Workflow
**Suggested filename:** `research-discovery-process.md`
